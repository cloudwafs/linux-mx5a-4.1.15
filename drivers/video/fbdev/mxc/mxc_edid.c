...
const struct fb_videomode mxc_cea_mode[64] = {
	...
	[47] = {
        ...
        [48] = {
                NULL, 60, 1680, 1050, 8403, 48, 80, 3, 21, 32, 6,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [49] = {
                NULL, 60, 1024, 768, 17857, 48, 80, 3, 15, 32, 4,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [50] = {
                NULL, 60, 800, 600, 28169, 48, 80, 3, 11, 32, 4,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [51] = {
                NULL, 60, 1280, 800, 14085, 48, 80, 3, 14, 32, 6,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [52] = {
                NULL, 60, 1360, 768, 13889, 48, 80, 3, 14, 32, 5,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [53] = {
                NULL, 60, 1440, 900, 11268, 48, 80, 3, 17, 32, 6,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [54] = {
                NULL, 60, 1920, 1200, 6493, 48, 80, 3, 17, 32, 6,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
        [55] = {
                NULL, 30, 3840, 2160, 4759, 48, 80, 3, 17, 32, 6,
                FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
                FB_VMODE_NONINTERLACED , 0
        },
};
