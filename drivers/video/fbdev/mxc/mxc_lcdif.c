...
static struct fb_videomode lcdif_modedb[] = {
	{
	/* 800x480 @ 57 Hz , pixel clk @ 25MHz */
	"CLAA-WVGA", 57, 800, 480, 40000, 40, 60, 10, 10, 20, 10,
	FB_SYNC_CLK_LAT_FALL,
	FB_VMODE_NONINTERLACED,
	0,},
	{/* 1920X360 @ 60 Hz , pixel clk @ 125MHz */
        "FULLHD-CUT3", 60, 1920, 360, 8000, 40, 60, 10, 730, 20, 10,
        FB_SYNC_CLK_LAT_FALL,
        FB_VMODE_NONINTERLACED,
        0,},
	{
