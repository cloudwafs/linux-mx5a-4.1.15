...
static int imx_get_sensor_data(struct platform_device *pdev)
{
	 ...
	 */
	of_property_read_u32(pdev->dev.of_node, "temp_passive", (u32 *)&data->temp_passive);
	if(!data->temp_passive)
	 ...
	 */
	of_property_read_u32(pdev->dev.of_node, "temp_critical", (u32 *)&data->temp_critical);
